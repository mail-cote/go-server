...
const (
	User_GetUser_FullMethodName   = "/v1.member.User/GetUser"
	User_ListUsers_FullMethodName = "/v1.member.User/ListUsers"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/v1/member/member.proto",
}
